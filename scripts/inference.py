...
def make_batches(lines: Iterable[str], args, src_dict, max_positions, bpe=None):
    tokens = [
        tokenizer.Tokenizer.tokenize(
            src_str, src_dict, tokenize=tokenizer.tokenize_en, add_if_not_exist=False, bpe=bpe
        ).long()
...
def main(models):
    ...
    # print(
    #     "Model throughput (beam {}): {} tokens/s".format(args.beam, log_dict["throughput"]),
    #     file=sys.stderr,
    # )
    # print(
    #     "Latency:\n\tAverage {:.3f}s\n\tp90 {:.3f}s\n\tp95 {:.3f}s\n\tp99 {:.3f}s".format(
